...
const constants = {
   ...
   */
  MONITORING_SCRIPT_FIELD: '>>',
  /**
   * The error message when the monitoring script path is outside the current working directory.
   */
  MONITORING_SCRIPT_PATH_ERROR: 'Input script must be a local file path.',
  /**
   * The error message on failure to read the monitoring script.
   */
  MONITORING_SCRIPT_READ_ERROR: 'Failed to read script.',
}
