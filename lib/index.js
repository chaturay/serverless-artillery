...
const constants = {
  ...
  ServerlessFiles: [
    'aws-alert/index.js',
    'handler.js',
    ...['index.js', 'define.js', 'invoke.js', 'handle.js', 'valid.js'].map(file => path.join('aws-func', file)),
    'package.json', 'package-lock.json',
    'serverless.yml',
    ...['index.js', 'define.js', 'execute.js', 'plan.js', 'result.js', 'valid.js'].map(file => path.join('task-artillery', file)),
  ],
  ...
  findScriptPath: (scriptPath) => {
    if (scriptPath) {
      ...
      if (impl.fileExists(localDefaultScript)) {
        ...
        return path.join(__dirname, 'faas', constants.DefaultScriptName)
      }
    }
  },
  /**
...
`,
  ...
  findServicePath: () => {
    ...
    if (impl.fileExists(localServerlessPath)) {
      ...
      return path.join(__dirname, 'faas')
    }
  },
  /**
