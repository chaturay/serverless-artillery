    ...
    if (
      ...
      if (
        ...
        if (
          ...
          service.functions[constants.TestFunctionName].environment.TOPIC_ARN.Ref &&
          !(
            service.resources.Resources[service.functions[constants.TestFunctionName].environment.TOPIC_ARN.Ref].Subscription &&
            Array.isArray(service.resources.Resources[service.functions[constants.TestFunctionName].environment.TOPIC_ARN.Ref].Subscription) &&
            service.resources.Resources[service.functions[constants.TestFunctionName].environment.TOPIC_ARN.Ref].Subscription.length > 0
          )
        ) {
          console.warn('No subscriptions are supplied for the SNS topic associated with your enabled monitoring event')
        }
      }
    }
  },
