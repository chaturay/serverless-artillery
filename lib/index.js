      ...
      .then(() => {
        ...
        return module.exports.remove(options)
          .then(() => {
            ...
            console.log(`${os.EOL}You can re-deploy after ${deployTime.toLocaleTimeString('en-US')} to avoid possible problems. See https://github.com/Nordstrom/serverless-artillery/#Killing-a-Runaway-Performance-Test${os.EOL}`)
          })
      })
  },
  /**
