...
const constants = {
  ...
  ServerlessFiles: [
    'alert.js',
    'handler.js',
    'aws-func/index.js', 'aws-func/define.js', 'aws-func/invoke.js', 'aws-func/handle.js', 'aws-func/valid.js',
  ...
  findScriptPath: (scriptPath) => {
    if (scriptPath) {
      ...
      if (impl.fileExists(localDefaultScript)) {
        ...
        return path.join(__dirname, 'function', constants.DefaultScriptName)
      }
    }
  },
  /**
